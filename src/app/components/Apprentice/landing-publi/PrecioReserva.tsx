  ...
  return (
    <div className="border rounded-lg p-6 shadow-sm" style={{ borderColor: "#41BFB3", backgroundColor: "#F0F7F6" }}>
      <div className="flex justify-between items-center mb-6">
        <div className="font-bold text-2xl" style={{ color: "#275950" }}>$350.000 COP</div>
      ...
      <div className="border rounded-lg mb-6" style={{ borderColor: "#91F2E9" }}>
        <div className="grid grid-cols-2 border-b" style={{ borderColor: "#91F2E9" }}>
          <div className="p-3 border-r" style={{ borderColor: "#91F2E9" }}>
            ...
            <div className="text-sm font-medium" style={{ color: "#275950" }}>12/05/2023</div>
          </div>
          <div className="p-3">
            <div className="text-xs" style={{ color: "#2A8C82" }}>SALIDA</div>
            <div className="text-sm font-medium" style={{ color: "#275950" }}>12/06/2023</div>
          </div>
        </div>
        <div className="p-3">
      ...
      <Link href="/PropertyPage">
        <button className="w-full mb-4 text-white py-3 rounded-lg font-medium hover:bg-opacity-90 transition-colors" 
